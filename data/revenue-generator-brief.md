# Revenue Generator, Intelligence Brief
...
- Strategic Account Executive (enterprise-focused)
- Account Manager (in orgs where AM owns expansion alongside acquisition)
- Sales Representative (in smaller orgs without AE title differentiation)

**Seniority variations:**
- 50-150 employees: Often a generalist AE who handles full-cycle from prospecting to close
- 150-350 employees: Typically a specialized AE who receives qualified opportunities from SDRs
- 350-500 employees: May be segmented by territory, vertical, or deal size (SMB vs MM vs Enterprise AE)

**Edge cases that fit:**
- Partner AE: structurally channel-focused but operationally equivalent on their net new number
...
**Daily:** Revenue Generators open the CRM deal view first. They check what moved overnight: stage changes, champion email responses, contract edits from legal, close-date nudges from their manager. They prep for the day's discovery calls and demos, run a quick portfolio scan for deals crossing aging thresholds, and log activity from the prior day before the tracking window closes.
...
**Podcasts:**
- *30 Minutes to President's Club*, peer practitioner takes on AE motions, demo mechanics, and close strategies
- *The Official SaaStr Podcast*, CEO/CRO context on what is working across growth-stage SaaS
- *Make It Happen Mondays* (John Barrows), prospecting and discovery call technique
- *The Sales Evangelist* (Donald Kelly), quota attainment tactics at the deal level

**Communities:**
- Bravado, AE peer community with quota attainment and deal-tactics threads
- RepVue, comp transparency and quota-attainment benchmarking
- Sales Hacker community, practitioner-level tactics and objection-handling discussions
...
**1. Deals that go quiet after the executive demo.**
The AE lands a great demo, gets verbal enthusiasm, and then three days pass with no response. The champion disengaged or the buying committee dynamic shifted, and the AE does not know which. *Goal-pursuit friction: Goal 1 (Closing Deals in Flight).*

**2. Coverage ratios that look fine but hide concentration.**
...
**5. Expansion-ready accounts surface as surprises.**
A newly onboarded account hits a usage milestone that signals expansion, and the CS team mentions it in passing at the QBR. The AE could have had a discovery touch two weeks earlier. *Cross-functional friction: Revenue Generator to Customer Advocate.*
...
**Recommendations about what to do with a deal.** The AE is the deal owner. Telling them to "follow up on Sterling" or "re-engage the champion" is overreach. Lens surfaces what happened and what it means numerically; the AE decides what to do.

## 7. Five "that's me" quotes they would say

**Quote 1:** "Three of my top five deals are in the same stage with no activity in ten days. I need to know which one to call first."

**Quote 2:** "Our win rate on Competitor A doubled this quarter. I want to know which card move made the difference."

**Quote 3:** "The pipeline looks fine on paper, but $1.2M of it is sitting in evaluation at two accounts. That is not 3.4x coverage, that is concentration risk."

**Quote 4:** "I closed that deal because the CSM flagged the onboarding milestone two weeks before the QBR. Timing is everything."

**Quote 5:** "If I had known Competitor B was in that evaluation on day one, I would have led with the integration story. Instead I found out on day fifteen."
...
**Revenue Leader (Manager):** Direct report relationship. The Revenue Leader reviews the AE's deal commit weekly and expects stage discipline, MEDDIC documentation, and accurate close-date forecasting. The AE's deal-level data feeds the leader's aggregate read.

**Revenue Developer (SDR):** Pipeline creation partner. The SDR qualifies inbound and outbound opportunities and hands them to the AE for discovery and close. Routing quality, acceptance rates, and speed-to-first-call timing define the relationship.
