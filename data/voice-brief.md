...
- **Card structure: Headline + Body.** Headline: factual observation. Body: anchor sentence (specificity, correlation) + connect sentence (wider context). No section labels in the UI. See the Card Generation Framework for the full composition contract.
